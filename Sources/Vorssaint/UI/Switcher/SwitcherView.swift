...
struct SwitcherView: View {
    ...
    private var cardGrid: some View {
        ScrollViewReader { proxy in
            ...
            .scrollDisabledCompat(switcher.grid.rows <= switcher.grid.visibleRows)
            .onChange(of: switcher.selectedIndex) { newIndex in
            ...
            ZStack(alignment: .topLeading) {
                VStack(spacing: 10) {
                    ...
                    ScrollViewReader { proxy in
                        ...
                        .scrollDisabledCompat(appWindows.count <= Int(switcher.iconRowLayout.previewContentWidth / SwitcherIconRowLayout.previewCardWidth))
    ...
    private var iconRow: some View {
        ...
        return ScrollViewReader { proxy in
            ...
            .scrollDisabledCompat(groups.count <= switcher.iconRowLayout.visibleIconCount)
