...
private struct MenuBarSetupStep: View {
    ...
    private var menuBarToggleList: some View {
        VStack(spacing: 0) {
            menuBarToggleListPrimary
            menuBarToggleListSecondaryA
            menuBarToggleListSecondaryB
        }
    }

    @ViewBuilder
    private var menuBarToggleListPrimary: some View {
    ...
    @ViewBuilder
    private var menuBarToggleListSecondaryA: some View {
        Divider()
    ...
    @ViewBuilder
    private var menuBarToggleListSecondaryB: some View {
        Divider()
...
private struct OptionalFeaturesStep: View {
    ...
    var body: some View {
        VStack(spacing: 18) {
            ...
            VStack(alignment: .leading, spacing: 14) {
                ...
                Group {
                    optionalFeatureToggle(title: l10n.s.invertMouseScroll,
                                          caption: l10n.s.scrollTrackpadNote,
                                          isOn: $inverterEnabled) {
                        ScrollInverter.shared.syncWithPreferences()
                    }

                    Divider()

                    optionalFeatureToggle(title: l10n.s.switcherEnable,
                    ...
                    optionalFeatureToggle(title: l10n.s.cutPasteEnable,
                ...
                Group {
                    ...
                    optionalFeatureToggle(title: l10n.s.autoQuitEnable,
                    ...
                    optionalFeatureToggle(title: l10n.s.shelfEnable,
    ...
    private func optionalFeatureToggle(title: String,
                                       caption: String,
                                       isOn: Binding<Bool>,
