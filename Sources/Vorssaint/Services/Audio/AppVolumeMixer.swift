...
private final class TapGainEngine: GainEngine {
    ...
    init?(objects: [AudioObjectID], gain: Float, outputDeviceUID: String) {
        ...
        let aggregate: [String: Any] = [
            ...
            (kVorssaintAudioAggregateDeviceTapListKey as String): [[
                (kVorssaintAudioSubTapUIDKey as String): description.uuid.uuidString,
                (kVorssaintAudioSubTapDriftCompensationKey as String): true,
            ]],
            (kVorssaintAudioAggregateDeviceTapAutoStartKey as String): true,
        ]
